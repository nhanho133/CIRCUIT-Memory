# Source: https://github.com/hfawaz/cd-diagram/tree/master
...
def draw_cd_diagram(df_perf=None, alpha=0.05, title=None, labels=False, output_file = 'cd-diagram.png', width = 9, textspace = 1.5, fontsize = 22,
                    lowv=None, highv=None):
    """
